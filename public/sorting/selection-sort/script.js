import { swap2 } from "../../js/utils/swap2.js";
...
async function SelectionSort() {
  ...
  if (!isPlay) {
    ...
    for (var i = 0; i < blocks.length; i += 1) {
      ...
      blocks[minIndex].childNodes[1].classList.add("stripes");
      ...
      for (var j = i + 1; j < blocks.length; j += 1) {
        ...
        var value2 = Number(blocks[minIndex].childNodes[0].innerHTML);
        ...
        if (value1 < value2) {
          blocks[minIndex].childNodes[1].classList.remove("stripes");
          minIndex = j;
          blocks[minIndex].childNodes[1].classList.add("stripes");
          swapped = true;
          algoStepDesc.innerHTML =
      ...
      await swap2(blocks[i], blocks[minIndex], container);
...
function resetButon() {
  ...
  if (isPlay == true) {
    ...
    enableShuffleButton();
    algoStepDesc.innerHTML = "Selelction Sort Algorithm...";
  }
}
